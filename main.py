...
def parse_args():
    ...
    parser.add_argument("--first_step_epochs",type=int,default=10)
    parser.add_argument("--second_step_epochs",type=int,default=101)
    parser.add_argument("--seed",type=int,default=3407)
    parser.add_argument("--first_step_lr",type=float,default=1e-4)
    ...
    parser.add_argument("--path",type=str,default="/kaggle/input/mabsa-datasets")
...
def train(args):
    ...
    second_step_optimizer = torch.optim.AdamW(model.parameters(), lr=second_step_lr,
